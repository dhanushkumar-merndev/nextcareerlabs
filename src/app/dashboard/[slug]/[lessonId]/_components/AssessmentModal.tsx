...
export function AssessmentModal({
  ...
  return (
    ...
    >
      <DialogContent className="fixed inset-0 z-[10001] w-screen min-h-dvh max-w-none sm:max-w-none p-0 m-0 border-none rounded-none bg-background shadow-none overflow-hidden block translate-x-0 translate-y-0">
