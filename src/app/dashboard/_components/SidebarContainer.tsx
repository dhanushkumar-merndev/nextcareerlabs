  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="flex flex-col md:flex-row flex-1 overflow-hidden min-h-0">
        {/* DESKTOP SIDEBAR */}
        <div className="hidden min-[1025px]:block w-80 shrink-0 bg-background/50 backdrop-blur-sm h-[calc(100dvh)] min-h-[520px] overflow-hidden border-r border-border">
          {showSkeleton ? (
