...
export function FeatureCard({ title, description, Icon, isExpanded: externalExpanded, onToggle }: FeatureCardProps) {
  ...
  return (
    ...
    <Card 
      ...
      {/* Card Header */}
      <CardHeader className={`flex flex-row items-center gap-4 md:flex-col md:items-start md:gap-3 p-0 max-md:-mb-6 mb-0`}>
        {/* Icon Container */}
