  ...
  return (
    <section className="pt-10 flex justify-center">
      <div className="w-full max-w-7xl px-4">
        ...
        <div
          ref={headingRef}
          className="sticky top-28 z-30 bg-background/90 backdrop-blur pb-6 will-change-transform text-center"
        >
        ...
        <ul ref={containerRef} className="relative mt-12">
          {programs.map((program, i) => {
            ...
            return (
              <li
                key={i}
                className="stack-item sticky top-50 md:top-60 aspect-square md:aspect-5/2 rounded-xl bg-background border shadow-xl transform-gpu origin-top"
              >
                <div
