    ...
    <>
      <style
        dangerouslySetInnerHTML={{
          ...
          .animate-checkmark-scale {
            animation: checkmark-scale 0.6s ease-out forwards;
          }
      ...
      <div className="relative min-h-screen bg-background overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          {/* Success Icon with parallax effect */}
          <div
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-40 h-40 rounded-full bg-primary/20 blur-2xl animate-success-pulse" />
            </div>

            {/* Main icon */}
            <div className="relative bg-primary/10 rounded-full p-8 backdrop-blur-sm border border-primary/20 animate-checkmark-scale">
              <CheckCircle
